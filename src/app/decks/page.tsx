...
export default async function DecksPage() {
  ...
  const templates = DECK_TEMPLATES.map((t) => ({ id: t.id, name: t.name, scenario: t.scenario, category: t.category, description: t.description, themeId: t.themeId, cover: t.slides[0] }));
